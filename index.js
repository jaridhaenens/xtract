{
    const init = () => {
        ...
        let $athleteBtns = document.querySelectorAll('.re-athlete');
        let $athleteTallyBtns = document.querySelectorAll('.re-athlete-tally');
        let $affiliateBtns = document.querySelectorAll('.re-affiliate');
        let $newsletterBtns = document.querySelectorAll('.re-newsletter');
        let $news10offBtns = document.querySelectorAll('.re-news10off');
        ...
        if ($athleteBtns) {
            $athleteBtns.forEach($athleteBtn => {
                $athleteBtn.href = `/athlete-program?${params}`
            });
        }

        if ($athleteTallyBtns) {
            $athleteTallyBtns.forEach($athleteTallyBtn => {
                $athleteTallyBtn.href = `https://tally.so/r/3jeLO4?${params}`
            });
        }

        if ($affiliateBtns) {
            $affiliateBtns.forEach($affiliateBtn => {

                if (urlForTally.includes("nl.getxtract")) {
                    $affiliateBtn.href = `https://tally.so/r/w2ERJD?${params}`;
                    console.log("nl.getxtract");
                } else if (urlForTally.includes("de.getxtract")) {
                    $affiliateBtn.href = `https://tally.so/r/w2ERJD?${params}`;
                    console.log("de.getxtract");
        ...
        if ($newsletterBtns) {
            $newsletterBtns.forEach($newsletterBtn => {
                $newsletterBtn.href = `https://tally.so/r/mZ95Bo?${params}`
            });
        }

        if ($news10offBtns) {
            $news10offBtns.forEach($news10offBtn => {
                $news10offBtn.href = `https://tally.so/r/w8NA1z?${params}`
            });
        }
            ...
            switch (flavourValue) {
                case 'ginger-lemon':
                    ...
                    if ($firstImg) {
                        ...
                        $secondImg.src = "https://uploads-ssl.webflow.com/63490844110bde0b38588ea8/638791d85db021125e84ee9c_6376014131f5e45077022449_0B5A5179.jpg";
                        $secondImg.srcset = "https://uploads-ssl.webflow.com/63490844110bde0b38588ea8/638791d85db021125e84ee9c_6376014131f5e45077022449_0B5A5179.jpg";
                    }
